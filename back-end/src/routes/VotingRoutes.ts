...
app.get('/:id', (req, res) => votingController.getVotingById(req, res));
...
app.post('/vote/:userId/:votingId/:candidateId', (req, res) => votingController.voteForCandidate(req, res));

app.get('/history/:userId', (req, res) => votingController.getUsersVotingHistory(req, res));

app.get('/county/:county', (req, res) => votingController.getVotingsByCountyName(req, res));

app.get('/county/:county/city/:city', (req, res) => votingController.getVotingsByCityName(req, res));
